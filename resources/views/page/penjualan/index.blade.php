                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div style="float:right">
                                            <a href="/penjualan/form" class="btn btn-outline-success btn-md"><b>+</b> Tambah Data</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$item->qty}}</td>
                                                        <td>
                                                            <a href="/penjualan/edit/{{ $item->id }}" class="btn btn-outline-secondary btn-sm"><i class="fa fa-pencil-alt"><br>Edit</i></a>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            Yakin No Faktur <b>{{ $item->no_faktur }}</b> ingin dihapus?
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                                                            <form method="post" action="/penjualan/{{$item->id}}">
                                                                                @csrf
                                                                                @method('DELETE')
