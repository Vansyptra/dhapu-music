                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    <h4 class="mb-sm-0">Data Laporan Penjualan</h4>
                                    ...
                                    <div class="card-header">
                                        <div class="row g-3 col-12 align-items-center">
                                            ...
                                            <div class="col" style="float:right">
                                                <a href="#" onclick="this.href='/penjualan/cetakPertanggal/'+document.getElementById('tglawal').value + '/' +document.getElementById('tglakhir').value" 
