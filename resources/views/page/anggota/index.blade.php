                                ...
                                <div class="card">
                                    <div class="card-header">
                                        ...
                                        <div style="float:right">
                                            <a href="/anggota/form" class="btn btn-outline-success btn-md"><b>+</b> Tambah Data</a>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$item->no_hp}}</td>
                                                        <td>
                                                            <a href="/anggota/edit/{{ $item->id }}" class="btn btn-outline-secondary btn-sm"><i class="fa fa-pencil-alt"><br>Edit</i></a>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            Yakin data <b>{{ $item->nama }}</b> ingin dihapus?
                                                                        </div>
